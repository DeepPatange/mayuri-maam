      ...
      <div className="relative max-w-4xl mx-auto px-4 text-center" style={{ zIndex: 10 }}>
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            >
              Upload & Predict <FaArrowRight />
            </Link>
            <Link
              to="/about"
              className="px-8 py-3 border border-primary/30 hover:border-primary rounded-xl text-primary-light font-semibold transition-all duration-300 no-underline"
            >
              Learn More
            </Link>
          </div>
